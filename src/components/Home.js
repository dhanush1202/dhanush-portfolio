  ...
  return (
    ...
    <div className="w-full h-screen text-gray-300">
      <div className="max-w-[1200px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h2 className="text-2xl sm:text-4xl font-bold text-[#f19191] nameplate">
          Student
        </h2>
        <p className=" text-slate-300 py-4 max-w-[700px] abtmatter">
        ...
        <div>
          <button className="abtmatter text-white group text-xl border-white border-2 px-6 py-3 my-2 flex items-center hover:bg-[#f19191] hover:border-[#f19191] hover:rounded-lg  duration-500" onClick={props.clickhandle}>
            View More!
